...
<table class="table table-bordered"><thead><tr>
    ...
    allStores.forEach(store => {
        ...
        // New Column (for demonstration, using a static value or formula) newColumn = additionalOrders * 2
        let newColumnValue = additionalOrders * 2;
        mergedHTML += `<td>${newColumnValue}</td>`;
        mergedHTML += `</tr>`;
    });
    ...
    let newColumnTotal = newColumnList.reduce((a, b) => a + b, 0);
    mergedHTML += `<td id="New-Column-Total">${newColumnTotal}</td>`;
    mergedHTML += `</tr>`;
    ...
    mergedHTML += `<td></td>`; // New Column grand total (not needed)
    mergedHTML += `</tr></tfoot>`;
...
// new column include with the help of new function name of Newcolumn 📊 Final MeTablerged 1279